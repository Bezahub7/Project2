# Project2
## Project Overview
Purpose: In this project we will download and analyze the mobile device usage and user behavior dataset from Kaggle   
and create an interactive shiny app for exploring the data.  
The Shiny app explore mobile users behavior based on usage patterns. Users can subset, visualize and download (full or subsetted) data from the app.  
